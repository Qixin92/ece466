...
%1..........backlog
[arrival_time, packetsize_p, back_log1, back_log2, priority] = textread('output_scheduler.txt', '%f %f %f %f %f');
...
[packet_no_p1, packetsize_p_sink1, arrival_time_sink1] = textread('output_sink1.txt', '%f %f %f');
[arrival_time1, packetsize_p1, back_log11, back_log21, priority2] = textread('output_scheduler1.txt', '%f %f %f %f %f');
...
[packet_no_p1, packetsize_p_sink1, arrival_time_sink2] = textread('output_sink2.txt', '%f %f %f');
[arrival_time2, packetsize_p12, back_log111, back_log21, priority2] = textread('output_scheduler2.txt', '%f %f %f %f %f');
