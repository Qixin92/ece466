...
[arrival_time, packetsize_p2, back_log] = textread('output_scheduler_ex13_N9.txt', '%f %f %f');
...
%3............. sink output
[packet_no_p3, packetsize_p3, arrival_time] = textread('output_sink_ex1_N9.txt', '%f %f %f');
...
title('Number of Discarded packets for N=9');
xlabel('time (in microseconds)');
