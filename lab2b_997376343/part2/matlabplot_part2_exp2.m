...
%trace file
[packet_no_p, time_p, packetsize_p] = textread('output_gen_exp2.txt', '%f %f %f');
...
%token bucket output
[arrival_time, packetsize_p2, back_log, num_of_tokens] = textread('output_bucket_exp2.txt', '%f %f %f %f');
...
%sink output
[packet_no_p3, packetsize_p3, arrival_time] = textread('output_sink_exp2.txt', '%f %f %f');
